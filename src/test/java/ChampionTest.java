...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        //assertThat(sampleString1, anyOf(containsString(startString),endsWith("wrong")));
       ...
       // assertThat(sampleString1, containsString("Fo"));
        assertThat(sampleString1, anyOf(startsWith(startString), endsWith("outofFocus")));
        assertThat(sampleString2, allOf(startsWith("Player"), endsWith(endString), containsString("point")));
    }
    ...
    public void shouldChampionCountFive() {
        ...
        System.out.println("List info :: " + championList);
    ...
    public void shouldHasPropertyPosition() {
        ...
        System.out.println("champion info :: " + championList.get(2));
    }
    ...
    public void shouldHaveSomeChampName() {
        ...
        assertThat(champListNames.get(3), containsString("갈"));
    }
    ...
    public void shouldTopChampionIsDarius() {
        ...
        System.out.println("champion info :: " + filteredChampion.get().getName());
    }
